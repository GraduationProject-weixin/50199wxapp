...
# 50199wxapp微信小程序的快递管理平台的设计与实现ssm
...
此次开发这个基于微信小程序的快递管理平台，不仅仅满足用户的需要，也能跟上时代的发展风向，从技术的角度还是用户的角度上进行开发都是很有意义的。
## 1.4 论文研究内容
...
|1|Id|Int|id|否|
|2|addtime|Date|创建时间|是|
|3|kuaididanhao|String|快递单号|是|
|4|kuaidimingcheng|String|快递名称|是|
|5|tupian|String|图片|是|
|6|yonghuzhanghao|String|用户账号|是|
|7|yonghuxingming|String|用户姓名|是|
|8|yonghushouji|String|用户手机|是|
|9|zhidingweizhi|String|指定位置|是|
|10|peisongfei|String|配送费|是|
|11|jiequshijian|String|接取时间|是|
|12|wanchengshijian|datetime|完成时间|是|
|13|peisongzhanghao|String|配送账号|是|
|14|peisongyuan|String|配送员|是|
|15|peisongyuanshouji|String|配送员手机|是|
|16|wanchengbeizhu|String|完成备注|是|
|17|querenzhuangtai|String|确认状态|是|
...
|7|nianling|String|年龄|是|
|8|touxiang|String|头像|是|
|9|yonghushouji|String|用户手机|是|
4确认完成表
...
|5|tupian|String|图片|是|
|6|yonghuzhanghao|String|用户账号|是|
|7|peisongzhanghao|String|配送账号|是|
|8|wanchengshijian|String|完成时间|是|
|9|querenshijian|datetime|确认时间|是|
|10|peisongpingfen|String|配送评分|是|
|11|peisongpingjia|String|配送评价|是|
...
|7|yonghuxingming|String|用户姓名|是|
|8|yonghushouji|String|用户手机|是|
|9|kuaidiweizhi|String|快递位置|是|
|10|peisongleixing|String|配送类型|是|
|11|zhidingweizhi|String|指定位置|是|
|12|peisongfei|Integer|配送费|是|
|13|fabushijian|datetime|发布时间|是|
|14|yaoqiushijian|datetime|要求时间|是|
|15|yonghubeizhu|String|用户备注|是|
|16|peisongzhuangtai|String|配送状态|是|
|17|crossuserid|Integer|跨表用户id|是|
|18|crossrefid|Integer|跨表主键id|是|
...
|8|yonghushouji|String|用户手机|是|
|9|kuaidiweizhi|String|快递位置|是|
|10|zhidingweizhi|String|指定位置|是|
|11|peisongfei|String|配送费|是|
|12|jiequshijian|datetime|接取时间|是|
|13|peisongzhanghao|String|配送账号|是|
|14|peisongyuan|String|配送员|是|
|15|peisongyuanshouji|String|配送员手机|是|
|16|peisongwuliu|String|配送物流|是|
|17|dingdanzhuangtai|String|订单状态|是|
|18|userid|Integer|用户id|是|
7配置文件表
...
|9|yonghushouji|String|用户手机|是|
|10|fahuodi|String|发货地|是|
|11|kuaidiweizhi|String|快递位置|是|
|12|gengxinshijian|datetime|更新时间|是|
...
|1|Id|Int|id|否|
|2|addtime|Date|创建时间|是|
|3|peisongzhanghao|String|配送账号|是|
|4|mima|String|密码|是|
|5|peisongyuan|String|配送员|是|
|6|xingbie|String|性别|是|
|7|touxiang|String|头像|是|
|8|peisongyuanshouji|String|配送员手机|是|
